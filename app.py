...
with st.expander("실제 페이지 조회 기준"):
    st.write(
        ...
        "- 예약·결제 버튼을 실행하지 않습니다.\n"
        "- 사용자 모니터링 작업은 3초부터 실행됩니다.\n"
        "- 동일 열차의 코레일 페이지 새 조회는 30초 동안 공유됩니다.\n"
